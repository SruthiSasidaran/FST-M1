...
Create Table salesman(salesman_id int Primary Key,salesman_name varchar(20),salesman_city varchar(20), salesman_commission int);
Describe salesman;

--Activity2-Insert data into the salesman table
INSERT ALL
...
--Activity4-To add a new coumn to the salesman table
